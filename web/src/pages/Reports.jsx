...
const REPORT_NAMES = { oee: 'Rangkuman OEE', breakdown: 'Analisis Breakdown', pm: 'Jadwal Preventive Maintenance' };
  ...
  return (
    <div className="page-view active">
      ...
      <div className="report-grid">
        <div className="report-card" onClick={() => genReport('oee')}>
          <div className="report-icon">📊</div><div className="report-title">Rangkuman OEE</div>
          <div className="report-desc">Availability, Performance, Quality per Mesin</div>
        </div>
        ...
        <div className="report-card" onClick={doExport}>
          <div className="report-icon">📥</div><div className="report-title">Export CSV</div>
